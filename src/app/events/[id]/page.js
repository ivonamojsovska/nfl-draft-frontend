        ...
        <div>
            ...
            <div className='flex gap-[4.376rem] pt-[2.5rem] px-[1.875rem]'>
                ...
                <div className='w-full max-w-[1100px]'>
                    <h3 className='font-bold text-4xl pb-6'>Event Details</h3>
                    <BackToAllBtn text='Events' />
                <div>
                    <form className='grid grid-cols-2 gap-5 pt-10'>
                        <div>
                            <TextField id="outlined-basic" label="Event Name" variant="outlined" type="text" className='w-full'/>
                        </div>
                        <div>
                            <TextField id="outlined-basic" label="Location" variant="outlined" type="text" className='w-full'/>
                        </div>
                        <div className='col-span-2'>
                            <TextField id="outlined-basic" label="Colors" variant="outlined" type="text" className='w-full'/>
                        </div>
                        <div>
                            <div>
                                <p className='py-4 text-[#000000DE]'>Event Image</p>
                            </div>
                            <div>
                                <input
                                accept="image/*"
